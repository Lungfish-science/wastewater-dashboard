...
def convert_table_to_greatable(df_path: Path, last_updated: str) -> GT:
    """
    ...
    submitters = (
        ...
        .tab_header(title="Sequence Read Archive SARS-CoV-2 Wastewater Submissions", subtitle=last_updated)
